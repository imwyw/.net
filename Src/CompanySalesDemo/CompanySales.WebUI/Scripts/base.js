...
回调的简单案例说明
*/
function doSomethingWithNumber(callback) {
    var val = 100;
    /*
    模拟耗时操作，比如从服务端接收响应，不确定需要多长时间
    采用回调函数的方式进行处理
    */
    return callback(val);
}
...
*/
function doSomethingWithNumExtend(option) {
    var val = 100;
    return option.callback(val);
}

//doSomethingWithNumExtend({ callback: addNum });
